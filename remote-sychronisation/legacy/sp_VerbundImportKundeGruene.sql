...
/****** Object:  StoredProcedure [dbo].[sp_VerbundImportKundeGruene]    Script Date: 11.07.2025 17:43:36 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[sp_VerbundImportKundeGruene]
...
USING (SELECT * FROM [192.168.114.101\SQLEXPRESS].[Apobase].[dbo].[RW_APOBASE_Kunde]) AS REMOTEKUNDE
ON (LOCALKUNDE.diKdNr = REMOTEKUNDE.diKdNrAuto AND LOCALKUNDE.strIdent IN ('Verbund_Gruene'))
