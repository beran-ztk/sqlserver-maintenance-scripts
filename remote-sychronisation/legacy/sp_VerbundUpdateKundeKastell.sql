...
/****** Object:  StoredProcedure [dbo].[sp_VerbundUpdateKundeKastell]    Script Date: 11.07.2025 17:45:25 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_VerbundUpdateKundeKastell]
...
BEGIN
   ...
   SET [RemoteTable].[strVorname] = [LocalTable].[strVorname]
      ...
      ,[RemoteTable].[diKdNrHpt] = [dbo].[FKT_TranslateKdNrToKastell]([LocalTable].[diKdNrHpt])
      ...
      ,[RemoteTable].[diKdNrRechnung] = [dbo].[FKT_TranslateKdNrToKastell]([LocalTable].[diKdNrRechnung])
	  ...
	  FROM 
		[SERV4591469\SQLEXPRESS].[Apobase].[dbo].[RW_APOBASE_Kunde] AS RemoteTable
		INNER JOIN 
		[dbo].[RW_APOBASE_Kunde] AS LocalTable
		ON 
			[dbo].[FKT_TranslateKdNrToKastell](LocalTable.diKdNrAuto) = RemoteTable.diKdNrAuto
